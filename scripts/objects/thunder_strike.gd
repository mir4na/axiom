...
func _ready() -> void:
	if blade != null and blade.material_override != null:
		blade.material_override = blade.material_override.duplicate()
	if guard != null and guard.material_override != null:
		guard.material_override = guard.material_override.duplicate()
	if grip != null and grip.material_override != null:
		grip.material_override = grip.material_override.duplicate()
	if pommel != null and pommel.material_override != null:
		pommel.material_override = pommel.material_override.duplicate()
	if trail != null and trail.material_override != null:
		trail.material_override = trail.material_override.duplicate()
	if ground_flash != null and ground_flash.material_override != null:
		ground_flash.material_override = ground_flash.material_override.duplicate()
	_sword_mats.clear()
	if blade != null and blade.material_override is ShaderMaterial:
		_sword_mats.append(blade.material_override as ShaderMaterial)
	if guard != null and guard.material_override is ShaderMaterial:
		_sword_mats.append(guard.material_override as ShaderMaterial)
	if grip != null and grip.material_override is ShaderMaterial:
		_sword_mats.append(grip.material_override as ShaderMaterial)
	if pommel != null and pommel.material_override is ShaderMaterial:
		_sword_mats.append(pommel.material_override as ShaderMaterial)
	_trail_mat = trail.material_override as ShaderMaterial if trail != null else null
	_ground_mat = ground_flash.material_override as ShaderMaterial if ground_flash != null else null
...
func _apply_dimensions() -> void:
	if blade != null and blade.mesh is BoxMesh:
	...
	if guard != null and guard.mesh is BoxMesh:
	...
	if grip != null and grip.mesh is CylinderMesh:
	...
	if pommel != null and pommel.mesh is SphereMesh:
	...
	if trail != null and trail.mesh is PlaneMesh:
	...
	if ground_flash != null and ground_flash.mesh is CylinderMesh:
