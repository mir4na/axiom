...
@onready var _line_1: Label = get_node_or_null("BoardAnchor/Lines/Line1") as Label
@onready var _line_2: Label = get_node_or_null("BoardAnchor/Lines/Line2") as Label
@onready var _line_3: Label = get_node_or_null("BoardAnchor/Lines/Line3") as Label
...
func play_typewriter(char_interval: float, line_pause: float, _footer_pause: float) -> void:
